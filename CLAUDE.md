...
- **release.yml**: Semantic-release on push to `version-15` (maintenance branch, `15.x` range, channel `v15`) and `version-16` (release branch, `16.x` after seed tag). Version numbers track the target Frappe major.
